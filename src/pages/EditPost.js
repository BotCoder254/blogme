...
const EditPost = () => {
  ...
  const { data: blog, isLoading: isLoadingBlog, error: blogError } = useQuery({
    queryKey: ['blog', id],
    queryFn: async () => {
    ...
    onSuccess: (data) => {
      ...
      const coverImg = data.get('coverImage');
      if (coverImg) {
        setCoverImagePreview(coverImg.url());
  ...
  const updateBlogMutation = useMutation({
    mutationFn: async (blogData) => {
      ...
      blog.set('title', blogData.title);
      blog.set('content', blogData.content);
      blog.set('tags', blogData.tags);
      blog.set('excerpt', blogData.excerpt || '');
      ...
      // Upload the cover image if changed
    ...
    onError: (error) => {
      ...
      setErrors({
        general: error.message || 'Failed to update blog post. Please try again.',
      });
    },
  });
  ...
  const handleSubmit = async (e) => {
    ...
    await updateBlogMutation.mutate({
      ...formData,
      coverImage: coverImage, // Only pass if changed
    });
  };
  ...
  if (blogError) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen">
        ...
        <p className="text-gray-600 mb-6">{blogError?.message || 'The post could not be found or has been removed.'}</p>
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-dark-700 mb-2">Edit Blog Post</h1>
            <p className="text-dark-500">Update your blog post content and settings</p>
          </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-gray-200">
              <div className="flex space-x-2">
                ...
                <Button
                  ...
                  disabled={isUploading || updateBlogMutation.isLoading}
                >
                  Delete Post
                </Button>
              </div>
